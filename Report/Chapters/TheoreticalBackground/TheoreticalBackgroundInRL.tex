...
This concludes the theoretical background chapter. This chapter presented the problem of reinforcement learning with it's mathematical model and the known basic solution methods. The next chapter presents the approaches of solving a real world problem, the problem of driver-less cars more precisely, with some of the advanced RL methods.