...
The setup for testing is described in the introduction to this \Cref{cha:Result}. The same setup is then used on all the different tracks the car has been trained on, this is done to make sure that the results from the different tracks has the same parameters.  
