...
\documentclass[a4paper,11pt,fleqn,twoside,openright]{memoir} 	% Openright open chapters on right page (openany both pages)
...
\PassOptionsToPackage{hyphens}{url}\usepackage{hyperref}				% make refferences to hyperlinks
\hypersetup{
	colorlinks=true,
