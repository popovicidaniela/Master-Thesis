...
\documentclass[a4paper,11pt,fleqn,dvipsnames,oneside,openright]{memoir} 	% Openright open chapters on right page (openany both pages)
...
%            url=false,
%            isbn=true,
%            backref=false,			% Reference to page in the document
%            citereset=chapter,
%            maxcitenames=3,
%            maxbibnames=100,
%            block=none,
...
%\bibliography{bibtex.bib}			% Name of .bib-file
%\renewbibmacro{in:}{}				% remove "I:" before journal entry
%\DeclareFieldFormat[book]{volume}{Vol. \textbf{#1}} % change volumenotation
%\DeclareFieldFormat[article]{volume}{\textbf{#1}}	% change volumenotation
